...
class PGExecutionContext_psycopg2(PGExecutionContext):
    ...
    def _log_notices(self, cursor):
        ...
        # cursor
        if not cursor.connection.Notice or not isinstance(
            cursor.connection.Notice, collections_abc.Iterable
        ):
            return

        for notice in cursor.connection.Notice:
            # NOTICE messages have a
            # newline character at the end
            logger.info(notice.rstrip())

        cursor.connection.Notice[:] = []
